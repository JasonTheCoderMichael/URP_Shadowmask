...
void MixRealtimeAndBakedGI(inout Light light, half3 normalWS, inout half3 bakedGI, half shadowRangeMask, half4 shadowMask)
{
...
// PWRD* majiao //
    ...
    {
        light.shadowAttenuation = lerp(light.shadowAttenuation, bakedShadow, shadowRangeMask);
    }
    #endif
#endif
// PWRD* majiao //
